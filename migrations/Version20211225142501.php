 ...
 */
final class Version20211225142501 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE url CHANGE category category VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE user ADD language VARCHAR(255) DEFAULT NULL, CHANGE image_id image_id INT DEFAULT NULL, CHANGE credit credit INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE url CHANGE category category VARCHAR(255) CHARACTER SET utf8 DEFAULT \'NULL\' COLLATE `utf8_unicode_ci`');
        $this->addSql('ALTER TABLE user DROP language, CHANGE image_id image_id INT DEFAULT NULL, CHANGE credit credit INT DEFAULT NULL');
