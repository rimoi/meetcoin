 ...
 */
final class Version20220208200917 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE save_meetcoin_by_user (id INT AUTO_INCREMENT NOT NULL, message_id INT NOT NULL, user_id INT NOT NULL, created_at DATETIME NOT NULL, ip VARCHAR(255) DEFAULT NULL, INDEX IDX_8EA6E1B2537A1329 (message_id), INDEX IDX_8EA6E1B2A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE save_meetcoin_by_user ADD CONSTRAINT FK_8EA6E1B2537A1329 FOREIGN KEY (message_id) REFERENCES message (id)');
        $this->addSql('ALTER TABLE save_meetcoin_by_user ADD CONSTRAINT FK_8EA6E1B2A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE save_meetcoin_by_user');
