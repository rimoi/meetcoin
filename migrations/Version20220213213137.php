 ...
 */
final class Version20220213213137 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE save_meetcoin_by_user ADD comment LONGTEXT DEFAULT NULL, CHANGE ip ip VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE save_meetcoin_by_user DROP comment, CHANGE ip ip VARCHAR(255) CHARACTER SET utf8 DEFAULT \'NULL\' COLLATE `utf8_unicode_ci`');
